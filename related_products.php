...
<section class="sec-relate-product bg0 p-t-45 p-b-105">
    <div class="container">
        ...
        <div class="wrap-slick2">
            <div class="slick2">
                <?php
                $sqlProRelat = "SELECT * FROM `lc_product` WHERE `status` ='1' AND `id` != '".$pro_id."' AND `category` = '".$rowPro['category']."' AND `category_sub` = '".$rowPro['category_sub']."' LIMIT 8";
                        ...
                        <div class="block2">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="product-detail.php?id=<?php echo encode($rowProRelat['id'],LIAM_COINS_KEY);?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        <?php echo $rowProRelat['name'];?>
                                    </a>
