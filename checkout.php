							...
							<form name="frmLogin" id="frmLogin" method="post" action="control/login.php" style="display:none;">
								<div class="row p-b-20">
									...
									<div class="col-12 text-center">
										...
										<button type="submit" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" style="width: 250px;justify-content: center;margin: 0 auto;">
											Login
										</button>
									</div>
								</div>
						...
						<div class="m-l-25 m-r--38 m-lr-0-xl">
							...
							<div id="boxShipAdd" style="display:none">
								...
								<div class="row">
									<div class="col-12 col-sm-6 col-xl-6 col-lg-6">
										<label class="">FIRST NAME *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="text" name="ship_fname" placeholder="FIRST NAME" required value="<?php echo $fname;?>">
									</div>
									<div class="col-12 col-sm-6 col-xl-6 col-lg-6">
										<label class="">LAST NAME *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="text" name="ship_lname" placeholder="LAST NAME" required value="<?php echo $lname;?>">
									</div>
									<div class="col-12">
										<label class="">COMPANY NAME (OPTIONAL)</label>
									...
									<div class="col-12">
										<label class="">STREET ADDRESS *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="text" name="ship_address1" placeholder="House number and street name" required value="<?php echo $address1;?>">
									...
									<div class="col-12">
										<label class="">TOWN / CITY *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="text" name="ship_city" placeholder="" required value="<?php echo $city;?>">
									</div>
									<div class="col-12">
										<label class="">STATE / COUNTY *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="text" name="ship_state" placeholder="" required value="<?php echo $country;?>">
									</div>
									<div class="col-12">
										<label class="">POSTCODE / ZIP *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="text" name="ship_poscode" placeholder="" required value="<?php echo $zipcode;?>">
									</div>
									<div class="col-12 col-sm-6 col-xl-6 col-lg-6">
										<label class="">PHONE *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="text" name="ship_phone" placeholder="" required value="<?php echo $phone;?>">
									</div>
									<div class="col-12 col-sm-6 col-xl-6 col-lg-6">
										<label class="">EMAIL ADDRESS *</label>
										<input class="stext-111 cl2 plh3 size-116 p-lr-18" type="email" name="ship_email" placeholder="" required value="<?php echo $email;?>">
									</div>
