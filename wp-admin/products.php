...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Products</a> </div>
    <h1>Products</h1>
  </div>
  <div class="container-fluid">
    ...
    <div class="">
      <div class="btn-group">
        <a href="product_detail.php?mode=add"><button class="btn btn-success">Add Product</button></a>
      </div>
      <div class="btn-group">
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td style="vertical-align: middle;"><center><?php echo number_format($rowProList['price'],2);?></center></td>
