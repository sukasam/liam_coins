     ...
     if($_SERVER['REQUEST_METHOD'] === 'POST'){
        if(isset($_POST['_token'])){
            if(Token::check($_POST['_token'])){
                ...
                $sqlOrder = "INSERT INTO `lc_order` (`id`, `cus_id`, `order_number`, `order_date`, `order_total`, `payment_type`, `type_address`, `bill_fname`, `bill_lname`, `bill_company`, `bill_address1`, `bill_address2`, `bill_city`, `bill_country`, `bill_zipcode`, `bill_phone`, `bill_email`, `ship_fname`, `ship_lname`, `ship_company`, `ship_address1`, `ship_address2`, `ship_city`, `ship_country`, `ship_zipcode`, `ship_phone`, `ship_email`) 
                VALUES (NULL, '".$cus_id."', '".$orderTempo."', current_timestamp(), '".$total_price."', '".$paymeny_type."', '".$type_address."'
