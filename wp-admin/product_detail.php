...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="products.php" class="tip-bottom">Products</a> <a href="#" class="current"><?php echo $typeMode;?> Products</a> </div>
  <h1><?php echo $typeMode;?> Products</h1>
</div>
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" name="frm1" id="frm1" method="post" action="control/products.php" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="pro_price" placeholder="0.00" onkeypress="return isNumberKey(event)" value="<?php if(isset($rowProE['price'])){echo $rowProE['price'];}?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Product Detail :</label>
              <div class="controls">
                <textarea class="span11" name="pro_detail"><?php if(isset($rowProE['detail'])){echo strip_tags(stripslashes($rowProE['detail']));}?></textarea>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              <label class="control-label">Products Images</label>
              <div class="controls">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea class="textarea_editor span11" rows="6" name="pro_description" placeholder="Enter text ..."><?php if(isset($rowProE['description'])){echo strip_tags(stripslashes($rowProE['description']));}?></textarea>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Products Status</label>
              <div class="controls">
