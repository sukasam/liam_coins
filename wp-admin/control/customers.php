        ...
        if(isset($_POST['mode'],$_POST['_token'])){
            if(Token::check($_POST['_token'])){
                ...
                if($mode === "update"){
                    ...
                    @mysqli_query($conn,"UPDATE `lc_customer` SET `cus_company` = '".$cus_company."', `cus_title` = '".$cus_title."', `cus_fname` = '".$cus_fname."', `cus_lname` = '".$cus_lname."', `cus_phone` = '".$cus_phone."', `cus_email` = '".$cus_email."', `cus_username` = '".$cus_username."', `cus_references` = '".$cus_references."', `status` = '".$cus_status."', `confirm_email` = '".$confirm_email."' WHERE `id` = ".$cus_id.";");
